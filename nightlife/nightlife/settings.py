...
LOCALE_PATHS = [os.path.join(BASE_DIR, 'nightlife', 'locale')]
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'tickets/static')]  # Add this to ensure `tickets/static` is included
